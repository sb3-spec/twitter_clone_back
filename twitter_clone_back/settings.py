"""
Django settings for twitter_clone_back project.
...
SECRET_KEY = 'no^e7hxhokj8j-o9nlk82()qst6k8-(+m!4w(w01mbm!&669tk'
...
WSGI_APPLICATION = 'twitter_clone_back.wsgi.application'
